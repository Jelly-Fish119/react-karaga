          ...
          <div className="col-12 col-md-10 col-lg-8">
            <div className="card my-2">
              <div className="card-body px-4 py-2">
                ...
                <div className="mb-4">
                  <label className="form-label">Choose Sub Menu Title</label>
                  <div className="input-group">
                    <select className="form-control">
                      <option value="default">Default Tag Line</option>
                      <option value="custom">Custom Tag Line</option>
                ...
                <div className="mb-4">
                  <label className="form-label">Create Package Category</label>
                  <div className="input-group">
                    <input type="text" className="form-control" placeholder="You Tube URL:" />
                  </div>
                </div>
...
export default MainMenuTitileInner2;
